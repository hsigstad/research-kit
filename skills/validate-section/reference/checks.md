# /validate-section — check-kind catalog

Full specification of every check kind. Loaded at §4 of the procedure —
read it before running the checks selected in §3. SKILL.md carries the
procedure spine and the §3 selection table.
